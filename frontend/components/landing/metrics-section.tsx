...
const metrics = [
  {
    ...
    suffix: "",
    prefix: "",
    label: "Unverified payouts",
    sublabel: "since ArcProof launched",
  },
  {
    value: 100,
    suffix: "%",
    prefix: "",
    label: "Claims independently re-checked",
    sublabel: "never trust the provider's own source",
  },
  {
    value: 5,
    suffix: "%",
    prefix: "±",
    label: "Numeric tolerance band",
    sublabel: "documented per claim type",
  },
];
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#5eead4]/10 text-[#5eead4] text-xs font-mono">
        ...
        >
          ...
          <span>Sanctions DB</span>
          <span className="text-foreground">Arc settlement</span>
        </div>
      </div>
    </section>
  );
